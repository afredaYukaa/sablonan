...
<div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama">Nama pembeli</label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <select name="nama" id="nama" class="select2_single form-control nama" tabindex="-1" required="required">
                <option selected="true" value="" disabled ></option>
                  <?php foreach($get_pem as $gs){ ?>
          ...
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="alamat">alamat pembeli</label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <select name="alamat" id="alamat" class="select2_single form-control nama" tabindex="-1" required="required">
                <option selected="true" value="" disabled ></option>
                  <?php foreach($get_alamat as $gs){ ?>
                    <option value="<?php echo $gs; ?>"><?php echo $gs; ?></option>

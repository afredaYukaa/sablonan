      ...
      <div class="x_content">
        ...
        <section class="content invoice">
          ...
          <div class="row invoice-info">
            <div class="col-sm-4 invoice-col">
              Dari
              <address>
                              <strong>Djogja Karya Mandiri</strong>
                              <br>Ujung Harapan 
                              <br>Kab. Bekasi
                              <br>Telp: 085888123006
            ...
            <div class="col-sm-4 invoice-col">
              Ke
              <address>
                              <strong><?php echo $i->nama ?></strong>
                             <br><?php echo $i->alamat ?>
        ...
        <?php } ?>
          ...
          <div class="row no-print">
            <div class="col-xs-12">
              <button class="btn btn-default" onclick="print();"><i class="fa fa-print"></i> Cetak</button>
              <?php echo anchor('example/print/'.$i->ref, '<button class="btn btn-danger btn-xs" type="button"><span class="fa fa-trash"></span></button>');?>
               <a href="{{ route(') }}" class="btn btn-secondary btn-sm">Print</a>

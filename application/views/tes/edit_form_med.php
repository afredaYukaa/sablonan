      ...
      <div class="x_content">
        ...
        <form action="<?php echo base_url(). 'example/update_medicine'; ?>" method="post" class="form-horizontal form-label-left" novalidate>
          ...
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nama_obat">Nama Barang </label>
          ...
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="penyimpanan">Karyawan</label>
            <div class="col-md-6 col-sm-6 col-xs-12">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="number" id="stok" name="stok" required="required" data-validate-minmax="0,20000" class="form-control col-md-7 col-xs-12" value="<?php echo $m->stok ?>">
            </div>
          </div>
          ...
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="kedaluwarsa">Tanggal Input</label>
            <div class="col-md-6 col-sm-6 col-xs-12">

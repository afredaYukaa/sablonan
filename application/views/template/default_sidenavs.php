<div class="col-md-3 left_col menu_fixed">
	...
	<div class="">
 		<div class="navbar nav_title" style="border: 0;">
 			<!-- logo info -->
 			<div class="logo_pic">
 				<a href="<?php echo base_url(); ?>"><img src="<?php echo base_url('assets/images/dlm.png') ?>" alt="..." class="img-circle logo_img"></a>
 			</div>
			
		</div>
		<div class="profile">
		<a href="<?php echo base_url(); ?>" class="site_title"><span style="font-size: 20px;"><?php echo 'DJOGJA KARYA MANDIRI' ?></span></a>
		</div>
				...
				<ul class="nav side-menu">
					...
					<li><a><i class="fa fa-briefcase"></i> Barang <span class="fa fa-chevron-down"></span></a>
						<ul class="nav child_menu">
							<li><a href="<?php echo base_url('example/form_med') ?>">Tambah Barang</a></li>
							<li><a href="<?php echo base_url('example/table_med') ?>">Lihat Barang</a></li>
							<li><a href="<?php echo base_url('example/table_exp') ?>">barang Input </a></li>
							<li><a href="<?php echo base_url('example/table_stock') ?>">Baarang Habis</a></li>
					...
					<li><a><i class="fa fa-industry"></i> Pemasok <span class="fa fa-chevron-down"></span></a>
						<ul class="nav child_menu">
					...
					<li><a><i class="fa fa-users"></i> pembeli <span class="fa fa-chevron-down"></span></a>
						<ul class="nav child_menu">
							<li><a href="<?php echo base_url('example/form_pem') ?>">Tambah Pembeli</a></li>
                    		<li><a href="<?php echo base_url('example/table_pem') ?>">Lihat pembeli</a></li>
						</ul>
					</li>
